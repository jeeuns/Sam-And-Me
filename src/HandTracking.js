class HandTracking {
    ...
    isHandGrabbing(landmarks) {
        ...
        const isGrabbing = closedCount >= 3; // At least 3 fingers closed

        if (closedCount > 0) {
            console.log('Fist check: ${closedCount}/4 fingers closed, grabbing=${isGrabbing}');
        }
    ...
    updateGestures() {
        console.log('=== UPDATE GESTURES ===');
        console.log('  Dominant hand:', this.dominantHand);
        console.log('  Left detected:', this.handData.left.detected, 
                    'grabbing:', this.handData.left.grabbing);
        ...
        console.log('  Non-dominant hand:', nonDominant, 
                    'detected:', this.handData[nonDominant].detected,
                    'grabbing:', this.handData[nonDominant].grabbing);
        console.log('  → nonDominantGrabbing:', this.nonDominantGrabbing);
        ...
        if (this.onGestureChange) {
            ...
            console.warn('  ⚠️ No onGestureChange callback set!');
        }
        console.log('=========================');
    }
